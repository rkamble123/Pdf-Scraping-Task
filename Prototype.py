...
test_list = ['LDL Cholesterol','Non HDL Cholesterol','HDL Cholesterol','Triglycerides level','Cholesterol-Total','VLDL Cholesterol']
...
print(Main_data)
print(Main_data['user_1'])
date=[]
test_dict = []

print(len(Main_data['user_1']))

for i in range(len(Main_data['user_1'])):
    print(i)
...
data_index = date.index('04/06/2022')
print(test_dict[data_index])